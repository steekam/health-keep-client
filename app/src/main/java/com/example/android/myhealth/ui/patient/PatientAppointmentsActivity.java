...
public class PatientAppointmentsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_appointments) {
            Intent intent = new Intent(PatientAppointmentsActivity.this, PatientAppointmentsActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
            startActivity(intent);// Handle the camera action
        } else if (id == R.id.nav_prescriptions) {
            Intent intent = new Intent(PatientAppointmentsActivity.this, PatientPrescriptionsActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
            ...
            Intent intent = new Intent(PatientAppointmentsActivity.this, PatientAccountActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            Intent intent = new Intent(PatientAppointmentsActivity.this, LoginActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
            startActivity(intent);
        }
